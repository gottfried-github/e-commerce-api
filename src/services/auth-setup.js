...
function setup(store) {
    async function local(name, password, cb) {
        ...
        try {
            ...
            if ('code' in e && m.InvalidCriterion.code === e.code) return cb(null, false, m.InvalidCriterion('password is incorrect'))
    ...
    passport.use(new LocalStrategy(/*3 in 'Function'/'inward':*/{usernameField: 'name', passwordField: 'password'}, local))
