...
function testHandler() {
    ...
    describe("passed ValidationError", () => {
        it("assigns 400", () => {
            ...
            _errorHandler(m.ValidationError.create("message"), new Req(), new Res((_status) => {isEqual = status === _status}), () => {}, {
    ...
    describe("passed ResourceExists", () => {
        it("assigns 409", () => {
            ...
            _errorHandler(m.ResourceExists.create("message"), new Req(), new Res((_status) => {isEqual = status === _status}), () => {}, {
                isValidBadInputTree: () => true
            })
